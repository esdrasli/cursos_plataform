...
import { mockCreatorStudents } from '../../data/mockData';
      ...
      <div className="bg-white p-6 rounded-xl shadow-sm">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left">
            ...
            <tbody>
              {mockCreatorStudents.map(student => (
                <tr key={student.id} className="border-b hover:bg-gray-50">
                  ...
                  <td className="p-4 text-gray-500">{new Date(student.enrolledDate).toLocaleDateString('pt-BR')}</td>
