...
import CreatorBrandingPage from './pages/creator/CreatorBrandingPage';
    ...
    <Router>
      <Routes>
        ...
        <Route path="/carrinho" element={<CartPage />} />
              <Route path="/checkout/:id" element={<ProtectedRoute><CheckoutStripePage /></ProtectedRoute>} />
        ...
        <Route path="/affiliate/register" element={<ProtectedRoute><AffiliateRegisterPage /></ProtectedRoute>} />
          ...
          <Route path="courses/platform/:courseId" element={<CoursePlatformEditor />} />
